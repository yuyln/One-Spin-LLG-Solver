...
void Calcdsdt(){
	reseta();
	calcTudo(desc, aux);
	r1->x = (vects[0]->x) * h / 2.0;
	r1->y = (vects[1]->y) * h / 2.0;
	r1->z = (vects[2]->z) * h / 2.0;
	reseta();
	calcTudo(r1, aux);
	r2->x = (vects[0]->x) * h / 2.0;
	...
	r4->z = (vects[2]->z) * h;
	reseta();
	dsdt->x = (2.0 * r1->x + 4.0 * r2->x + 2.0 * r3->x + r4->x) / 6.0;
	dsdt->y = (2.0 * r1->y + 4.0 * r2->y + 2.0 * r3->y + r4->y) / 6.0;
	dsdt->z = (2.0 * r1->z + 4.0 * r2->z + 2.0 * r3->z + r4->z) / 6.0;
}
